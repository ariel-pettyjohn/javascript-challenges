...
export default function areAnagrams (
    ...
    const characterFrequencies1: ICharacterFrequencies = getCharacterFrequencies(string1);
    const characterFrequencies2: ICharacterFrequencies = getCharacterFrequencies(string2);
